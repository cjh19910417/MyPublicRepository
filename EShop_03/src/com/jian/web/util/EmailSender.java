...
public class EmailSender {
    ...
    private static final String username = "eshopmail"; //登录用户名
    private static final String password = "123456";    //密码
    private static final String internetAddress = "eshopmail@sohu.com"; //发件人邮箱地址
    
    public static void main(String[] args) throws Exception {
    	EmailSender.send(new String[]{"c.jian417@gmail.com"}, "邮件测试xx", "<b>南雄数码网</b>", null , "text/html");
    }
    /**
     * 发送邮件
     * @param receiver 收件人
    ...
    public static void send(String[] receivers, String subject, String mailContent, File[] attachements, String mimetype) {
        ...
        props.put("mail.smtp.host", "mail.sohu.com");//smtp服务器地址 sohu
        ...
        session.setDebug(true);//debug模式开启
        try {
            MimeMessage mimeMessage = new MimeMessage(session);
            mimeMessage.setFrom(new InternetAddress(internetAddress));//发件人邮件
