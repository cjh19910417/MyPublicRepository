...
public class WebUtil {
     ...
     * @return
     */
    public static Employee getEmployeeInSession(HttpServletRequest request)
    {
	 ...
	 * @return
	 */
    public static String Base64encode(String prototype)
    {
        return new String(Base64.encodeBase64(prototype.getBytes()));
    }
    /**
     * 用base64解码一段字符串
     * @param encryption
    ...
    {
        return new String(Base64.decodeBase64(encryption));
    }
    /**
     * 得到session中的buyer
     * @param request
     * @return
     */
    public static Buyer getUserInSession(HttpServletRequest request)
    {
