...
import com.jian.web.formdatetype.converter.DateConverter;
import com.jian.web.formdatetype.converter.DeliverConverter;
import com.jian.web.formdatetype.converter.GenderConverter;
import com.jian.web.formdatetype.converter.OrderStateConverter;
import com.jian.web.formdatetype.converter.PaymentConverter;
import com.jian.web.formdatetype.converter.SystemPrivilegePKConverter;
...
public class CodeFilter implements Filter
{
    ...
    {
        // 注册一些类型转换器
        ConvertUtils.register(new GenderConverter(), Gender.class);// 注册性别转换器
        ConvertUtils.register(new PaymentConverter(), PaymentWay.class);// 支付方式类型转换器
        ConvertUtils.register(new DeliverConverter(), DeliverWay.class);// 配送方式类型转换器
        ConvertUtils.register(new OrderStateConverter(), OrderState.class);// 订单状态
        ConvertUtils.register(new DateConverter(), Date.class);
        ConvertUtils.register(new SystemPrivilegePKConverter(),
                              SystemPrivilegePK.class);
