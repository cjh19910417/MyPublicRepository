...
<frameset framespacing="0" border="0" rows="75,*,15" frameborder="0">
  ...
  <frameset cols="168,*">
    <frame name="menuframe" target="mainframe" src="<html:rewrite action='/control/center/menu'/>" scrolling="no" marginwidth="0" marginheight="0">
