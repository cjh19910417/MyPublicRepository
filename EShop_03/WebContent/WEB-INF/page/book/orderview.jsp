...
<c:forEach items="${order.items}" var="item">
        <tr>
          ...
          <td align="center" bgcolor="#FFFFFF">${item.amount } <a href="<html:rewrite action="/control/order/manage"/>?method=modifyProductAmountUI&orderitemid=${item.itemid }&orderid=${order.orderid }">修改</a></td>
...
<table width="90%" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr>
    <td colspan="3"  bgcolor="6f8ac4"><FONT COLOR="#FFFFFF">客服留言</FONT> &nbsp; <input type="button" value="客服留言" onclick="JavaScript:window.location.href='<html:rewrite action="/control/order/manage"/>?method=addMessageUI&orderid=${order.orderid}'"/></td>
  </tr>
  <tr>
    <td width="20%" align="center" bgcolor="#FFFFCC">留言者/时间</td>
    <td width="20%" align="center" bgcolor="#FFFFCC">时间</td>
    <td width="60%" align="center" bgcolor="#FFFFCC">内容</td>
  </tr>
  <c:forEach items="${order.msgs}" var="msg">
  <tr>
    <td align="center"><font color="red" size="2" style="font-weight: bold;">${msg.username }</font> </td>
    <td align="center">${msg.createtime }</td>
    <td align="center">${msg.content }</td>
  </tr>
  <tr><td colspan="3" height="1" bgcolor="#BBC9FF"></td></tr></c:forEach>
</table>
<p>&nbsp;</p>
</body>
</html>