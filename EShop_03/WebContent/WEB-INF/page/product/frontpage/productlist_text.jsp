		...
		<div class="goodslist">
          ...
          <div class="goods_right">
			  ...
			  <c:if test="${!empty entry.brand}"> <li>品牌：${entry.brand.name}</li></c:if>
	           ...
	           <div class="content">&nbsp;&nbsp;&nbsp;<c:out value="${fn:substring(entry.simpleDescription,0,200)}"/> ...</div>
	           <div class="message_bottom">
	                <div class="save"><s>￥${entry.marketprice}</s>　<strong><em>￥${entry.sellprice}</em></strong>　<c:if test="${entry.savedPrice>0}">
							 节省：<strong style="color: red;font-size:15px;">￥${entry.savedPrice}</strong> 
						</c:if></div>
