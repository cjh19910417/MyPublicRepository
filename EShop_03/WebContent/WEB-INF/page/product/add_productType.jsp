...
<br>
  ...
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center" >
    ...
    <tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">所属类别ID：</div></td>
      <td width="78%"> <html:text property="parentid" size="50" maxlength="50" readonly="true" disabled="true" />
        <font color="#FF0000">只读</font></td>
	...
	<tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <html:textarea property="note"  rows="5" cols="80" />
        </td>
    </tr>
    <tr bgcolor="f5f5f5"> 
