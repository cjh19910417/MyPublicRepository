...
function verifyForm(objForm){
	...
	for(var i=0;i<list.length;i++){
		var objfield = eval("objForm."+ list[i].name);//eval会执行括号里面的字符,可以达到拼接的目的
  ...
  <table width="98%" border="0" cellspacing="1" cellpadding="3" align="center">
	...
	<tr bgcolor="f5f5f5"> 
      ...
      <td width="75%"> <html:select property="brandid">
          ...
          <%--用struts标签遍历出brands集合里面的条目作为选项,label为下拉框的选项标签名为集合的name属性,value为集合的code属性() --%>
          <html:optionsCollection name="brands" label="name" value="code"/>
        </html:select>(<a href="<html:rewrite action='/control/product/brand/manage'/>?method=addUI">添加品牌</a>)</td>
    </tr>
	<tr bgcolor="f5f5f5"> 
      ...
      <td width="75%"><html:select property="sex">   
			...
			<html:option value="WOMAN">女士</html:option>
		</html:select>
		</td>
    </tr>
	<tr bgcolor="f5f5f5"> 
