	...
	*/
	...
	function validateFormData(){
		...
		if(form.mobile.value.trim()!=""){
			if(!/^1[358]\d{9}$/.test(form.mobile.value.trim())){
				alert("收货人的手机号格式不正确");
				return false;
			}
		}
...
<TABLE cellSpacing=0 cellPadding=0 align="center" border=0>
  <TBODY>
  <TR>
    <TD><IMG src="/images/global/logo.png" >   &nbsp;&nbsp;<IMG height=36 src="/images/buy/az-s-checkout-shipping-bann.gif" > </TD></TR></TBODY></TABLE><BR>
    ...
    <TD>
      ...
      <TABLE cellSpacing=1 cellPadding=4 width="100%" border=0>
        ...
        <TR>
          ...
          <TD><html:text property="recipients" maxlength="8" size="30"/><FONT color="#ff0000">*</FONT>&nbsp;<html:radio property="gender" value="MAN"/>先生 <html:radio property="gender" value="WOMAN"/>女士</TD></TR>
        <TR>
          <TD height="27">
        ...
        <TR id="buyerinfoInput" style="DISPLAY: none">
		  ...
		  <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
            <TR>
              ...
              &nbsp;<html:radio property="buyer_gender" value="MAN" />先生 <html:radio property="buyer_gender" value="WOMAN"/>女士</TD>
            </TR>
            <TR>
