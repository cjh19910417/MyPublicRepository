              ...
              <TR>
                <TD vAlign=top bgColor=#ffffff>
                  ...
                  width="100%" align=center border=0>
                    ...
                    <TR>
                      <TD vAlign=top>
                        <form action="/user/post.do" method="post" onsubmit="javascript:return validateForm(this)">
						...
						<INPUT TYPE="hidden" NAME="validateCode" value="${param.validateCode }">
                              <table border="0" cellpadding="4" cellspacing="4" width="100%">
                                ...
                                <tr align="left">
                                  <td>&nbsp;</td>
                                  <td align="right">
                                  	<input type="image" alt="完成" src="/images/login/az-finish.gif" border=0 name="image1" ID=Image1/>
                                  </td>
                                  <td>&nbsp;</td>
                                </tr>
                                  </tbody></table>
