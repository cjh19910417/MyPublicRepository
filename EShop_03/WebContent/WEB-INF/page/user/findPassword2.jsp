                    ...
                    <TR>
                      <TD vAlign=top><!--  content  -->
						<TABLE cellSpacing=4 cellPadding=4 width="100%" border=0>
                          <TBODY>
                          <TR align=left>
                            <TD><SPAN class=font-step>第二步：</SPAN><SPAN 
                              class=font14b>请查看您帐户设定的电子邮件信箱</SPAN></TD></TR>
                          <TR align=left>
                            <TD class=font9>
                              <P>为了验证您的身份，我们已发出了通知信，请在24小时内点击邮件内的链接继续设置新密码。</P></TD></TR>
                          <TR align=left>
                            <TD>
                          ...
                          <TR align=left>
                            <TD class=font9>
                              ...
                              href="/mapping/user/reg.htm">建议创建一个新帐户</A>。</P></TD></TR></TBODY></TABLE>
							<!--  content  -->
