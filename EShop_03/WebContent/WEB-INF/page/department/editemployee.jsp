...
<input type="hidden" name="method" value="editEmployee">
<html:hidden property="username"/>
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <html:radio property="gender" value="WOMAN">女</html:radio></td>
    </tr> 
	<tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">员工照片：</div></td>
      <td width="40%" valign="top"> <input type="file" name="picture" size="50">
     <c:if test="${!empty imagePath}"><img src="${imagePath}" border="0" width="80"></c:if> </td>
    </tr>
    <tr bgcolor="f5f5f5"> 
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <c:forEach items="${departments}" var="department" varStatus="statu">      
      	<input <c:if test="${selectdepartmentid==department.departmentid}">checked</c:if>
      	 type="radio" name="departmentid" value="${department.departmentid}">${department.name}	
