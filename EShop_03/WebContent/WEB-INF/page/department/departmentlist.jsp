...
<c:forEach items="${pageViewData.records}" var="entry">
    <tr>
      ...
      <jian:permission privilege="update" module="department">
      ...
      <td bgcolor="f5f5f5"> <div align="center">
      <jian:permission privilege="delete" module="department">
    ...
    <tr> 
      <td bgcolor="f5f5f5" colspan="4" align="center"><table width="100%" border="0" cellspacing="1" cellpadding="3">
          <tr> 
            <td width="5%"></td>
              <td width="85%">
           <jian:permission privilege="insert" module="department">
