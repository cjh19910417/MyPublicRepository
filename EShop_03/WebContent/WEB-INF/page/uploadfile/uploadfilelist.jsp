...
<c:forEach items="${pageViewData.records}" var="entry">
    ...
    <tr>
      ...
      <td bgcolor="f5f5f5" colspan="4" align="center"><table width="100%" border="0" cellspacing="1" cellpadding="3">
          <tr> 
            <td width="10%" align="center"><INPUT TYPE="checkbox"  NAME="all" onclick="javascript:allselect(this, this.form.fileids)">全选</td>
              <td width="10%">
              <input type="button" class="frm_btn" onClick="javascript:deleteFiles(this.form)" value=" 删 除 "> &nbsp;&nbsp;
            </td>
            <td width="80%">
              <input type="button" class="frm_btn" onClick="javascript:window.location.href='<html:rewrite action="/control/uploadfile/manage"/>?method=uploadUI'" value="上传文件"> &nbsp;&nbsp;
            </td>
          </tr>
        </table></td>
    </tr>
